...
306 | 9 subfolders with binaries | ???
307 | 29 binarues and a script rename.sh that renamed each file from 22.* to 307.* | txt
...
I suspect the videos are in folder 300 and the music in 324