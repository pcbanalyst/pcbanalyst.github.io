...
Released at 2600000 Yen on 2007-04-19 it is now EOL and turning up on yahoo auctions now for around 5000 Yen or less.
...
# Notes
The serial port is one of the DIN sockets marked コントロール. It's at RS232 levels (+-12V!!). The top 2 pins are TX/RX and the middle right is Ground. It's at 115200 baud and will output garbage while the machine is off.
